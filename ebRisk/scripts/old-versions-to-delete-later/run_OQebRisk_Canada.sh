...
You need to have created the ini files already. Originally written by TE Hobbs on 3 Aug 2021.


USAGE: run_OQebRisk.sh 
    to be run from the CanadaSRM-output/ebRisk/ folder. Automatically runs b0 and r1.
